...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		//TODO: add code to display a marker
	...
	{	
		...
		fill(0, 0, 0);
        text("Earthquake key", 50, 70, 100, 100);

        fill(255, 0, 0);
        ellipse(50, 120, 15, 15);
        fill(0, 0, 0);
        text("5+ magnitude", 70, 113, 100, 100);

		fill(255, 255, 0);
		ellipse(50, 160, 10, 10);
		fill(0, 0, 0);
		text("4+ magnitude", 70, 153, 100, 100);

		fill(0, 0, 255);
		ellipse(50, 200, 5, 5);
		fill(0, 0, 0);
		text("4- magnitude", 70, 193, 100, 100);
